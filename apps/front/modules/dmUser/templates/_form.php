...
echo _open('div.box.mt20 style="width: 400px; margin: auto;"');

echo _tag('p.box_title', 'Get a free account');

echo $form->open('.dm_register_form.box_inner');
...
echo _open('ul.dm_form_elements');
  ...
  {
    echo _tag('li.dm_form_element', $form['captcha']->field()->error());
  }
